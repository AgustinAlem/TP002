...
#JUGADOR 2
    ...
    if opcionj2 != 1 or opcionj2 != 2:
        ...
        if ((dado1j2 + dado2j2 + dado3j2) % 2) == 0 and opcionj2 == 1:
            puntajej2 += max(dado1j2, dado2j2, dado3j2) * 2

        elif ((dado1j2 + dado2j2 + dado3j2) % 2) == 0 and opcionj2 == 2:
            puntajej2 = puntajej2 - min(dado1j2, dado2j2, dado3j2)

        elif ((dado1j2 + dado2j2 + dado3j2) % 2) == 1 and opcionj2 == 2:
            puntajej2 += max(dado1j2, dado2j2, dado3j2) * 2

        elif ((dado1j2 + dado2j2 + dado3j2) % 2) == 1 and opcionj2 == 1:
            puntajej2 = puntajej1 - min(dado1j2, dado2j2, dado3j2)
